...
# ---------------------------------------------------------------------------
# Deterministic path resolution (path_utils)
# ---------------------------------------------------------------------------
...
PROJECT_ROOT = get_project_root(THIS_FILE)
...
class Go2Deployer:
    ...
    def __init__(self, net_if, cfg_path):
        ...
        cfg_path = get_deploy_config_path(__file__, "v1", cfg_path)
        ...
        log_dir = os.path.join(
            PROJECT_ROOT, "plots", "real_op", "go2_hw", timestamp
        )
